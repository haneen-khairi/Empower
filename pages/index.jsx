      ...
      {isLoading ? (
        ...
        <>
          <div className="signup_alert">
            <p>
              If you're experiencing difficulties achieving your academic
              objectives and seeking an individual to comprehend your situation
              thoroughly and devise a career strategy for you, EMPWR360 is the
          ...
          <section className="platform mt-[24px]">
            <div className="platform__content">
              <h2 className="platform__content--title">
                OUR PLATFORM
              </h2>
              <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 justify-center gap-[12px]">
                <div className="platform__content--card">
                  <h4 className="platform__content--card-name">
                    Comprehensive Assessments
                  </h4>
                  <p className="platform__content--card-text">
                    "Empower360 has been instrumental in shaping my career
                    trajectory. Through their comprehensive assessments like The
                    Learning Receptiveness Profiles test and The NAP Student
                    Performer Brain Profile Assessment, I gained valuable
                    insights into my unique learning style and cognitive
                    strengths. Their guidance aligned my interests with my
                    neural architecture, providing a clear direction for my
                    future career. Thanks to Empower360, I now approach my
                    professional journey with confidence and purpose."
                  </p>
                </div>
                <div className="platform__content--card">
                  <SiteImage 
                  src={'/assets/images/folder-new-design/2.svg'}
                  />
                </div>
                <div className="platform__content--card">
                  <h4 className="platform__content--card-name">
              ...
              <div className="flex  justify-center gap-[12px]">
                ...
                <div className="w-1/2  platform__content--card mt-[0px]">
                  ...
                  <p className="platform__content--card-text">
                    The platform offers personalized career recommendations and strategies for success
                    based on the results of these assessments, helping students make informed decisions
          ...
          <section className="partners mt-[24px]">
            <div className="partners__content">
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-[12px]">
                <div className="partners__content--image">
                  <SiteImage src={"/assets/images/folder-new-design/3.svg"} />
                </div>
                <div className="partners__content--image">
                  <SiteImage src={"/assets/images/folder-new-design/4.svg"} />
                </div>
                <div className="partners__content--image">
          ...
          <section className="satisfied mt-[24px]">
            <div className="satisfied__content">
              <h2 className="satisfied__content--title">
                OUR SATISFIED CUSTOMERS
              </h2>
              <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-[12px]">
                <div className="satisfied__content--card">
                  <p className="satisfied__content--card-text">
                    "Empower360 has been instrumental in shaping my career
                    trajectory. Through their comprehensive assessments like The
                    Learning Receptiveness Profiles test and The NAP Student
                    Performer Brain Profile Assessment, I gained valuable
                  ...
                  <h4 className="satisfied__content--card-name">
                    -Noor Al-Jannahi
                  </h4>
                </div>
                <div className="satisfied__content--card">
          ...
          <section id="about" ref={aboutUsRef} className="what mt-[24px]">
            ...
            <div className="grid grid-cols-6">
              <div className="col-span-1">
                <SiteImage
                  className="what__image"
                  src={"/assets/images/folder-new-design/6.svg"}
                />
              </div>
              <div className="col-span-5">
                <div className="">
                  <h4 className="what__content--header">OUR STORY</h4>
                  <p className="what__content--text">
                    Empower360 was created by a group of UAE graduates who
                    experienced the challenges students faced in making career
                    decisions. The platform combines science-based assessments
                    with personalized guidance from internationally known
                    companies specialized in professional development.
                    Empower360 aims to help students confidently navigate their
                    career paths and find fulfillment in the ever-changing job
                    market.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2">
              <div className="grid grid-cols-6 gap-[8px]">
                <div className="col-span-1">
                  <SiteImage
                    ...
                    src={"/assets/images/folder-new-design/7.svg"}
                  />
                </div>
                <div className="col-span-5">
                  <div className="">
                    <h4 className="vision__content--header">OUR VISION</h4>
                    <p className="vision__content--text">
                      Empower360 aims to be the top science-driven career
                      guidance platform, helping students worldwide pursue
                      fulfilling careers that match their potential and
                      transforming career decision-making.
                    </p>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-6 gap-[12px]">
                <div className="col-span-1">
                  <SiteImage
                    className="vision__image"
                    src={"/assets/images/folder-new-design/8.svg"}
                  />
                </div>
                <div className="col-span-5">
                  <div className="">
                    ...
                    <p className="vision__content--text">
                      Empower360 aims to revolutionize student career success by
                      providing science-based assessments and personalized
                      guidance to help students discover their unique strengths
                      and interests. Their goal is to boost confidence, improve
                      academic outcomes, and equip students with the knowledge
                      to make informed career decisions in today's dynamic job
                      market
                    </p>
                  </div>
                </div>
